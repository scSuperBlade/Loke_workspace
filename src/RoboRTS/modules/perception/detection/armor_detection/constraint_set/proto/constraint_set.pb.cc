...
void protobuf_AssignDesc_constraint_5fset_2eproto() {
  ...
  static const int ConstraintSetConfig_offsets_[13] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ConstraintSetConfig, gimbal_offset_z_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ConstraintSetConfig, camera_and_armor_diff_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ConstraintSetConfig, optical_axis_offset_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ConstraintSetConfig, yaw_offset_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ConstraintSetConfig, pitch_offset_),
  };
...
void protobuf_AddDesc_constraint_5fset_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\024constraint_set.proto\"\331\002\n\tThreshold\022\036\n\026"
    ...
    "\002(\002\022\026\n\016armor_max_mean\030\n \002(\002\022\024\n\014color_thr"
    "ead\030\013 \002(\002\022\023\n\013blue_thread\030\014 \002(\002\022\022\n\nred_th"
    "read\030\r \002(\002\"*\n\tArmorSize\022\r\n\005width\030\001 \002(\002\022\016"
    "\n\006height\030\002 \002(\002\"U\n\023SignalRecognization\022\024\n"
    "\014max_wait_fps\030\001 \002(\r\022\027\n\017min_pulse_angle\030\002"
    " \002(\002\022\017\n\007min_num\030\003 \002(\r\"\377\002\n\023ConstraintSetC"
    "onfig\022\026\n\016init_camera_id\030\001 \002(\005\022\024\n\014enable_"
    "debug\030\002 \002(\010\022\023\n\013enable_neon\030\003 \002(\010\022\021\n\tusin"
    "g_hsv\030\004 \002(\010\022\035\n\tthreshold\030\005 \002(\0132\n.Thresho"
    "ld\022\036\n\narmor_size\030\006 \002(\0132\n.ArmorSize\022 \n\013en"
    "emy_color\030\007 \002(\0162\013.EnemyColor\0222\n\024signal_r"
    "ecognization\030\010 \002(\0132\024.SignalRecognization"
    "\022\027\n\017gimbal_offset_z\030\t \002(\002\022\035\n\025camera_and_"
    "armor_diff\030\n \002(\002\022\033\n\023optical_axis_offset\030"
    "\013 \002(\002\022\022\n\nyaw_offset\030\014 \002(\002\022\024\n\014pitch_offse"
...
SignalRecognization::SignalRecognization()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:SignalRecognization)
}
...
SignalRecognization::SignalRecognization(const SignalRecognization& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:SignalRecognization)
}
...
SignalRecognization::~SignalRecognization() {
  // @@protoc_insertion_point(destructor:SignalRecognization)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:SignalRecognization)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:SignalRecognization)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:SignalRecognization)
  return false;
#undef DO_
}
...
void SignalRecognization::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:SignalRecognization)
  // required uint32 max_wait_fps = 1;
  if (has_max_wait_fps()) {
  ...
  // @@protoc_insertion_point(serialize_end:SignalRecognization)
}

::google::protobuf::uint8* SignalRecognization::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:SignalRecognization)
  // required uint32 max_wait_fps = 1;
  if (has_max_wait_fps()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:SignalRecognization)
  return target;
}
...
const int ConstraintSetConfig::kGimbalOffsetZFieldNumber;
const int ConstraintSetConfig::kCameraAndArmorDiffFieldNumber;
const int ConstraintSetConfig::kOpticalAxisOffsetFieldNumber;
const int ConstraintSetConfig::kYawOffsetFieldNumber;
const int ConstraintSetConfig::kPitchOffsetFieldNumber;
#endif  // !_MSC_VER
...
void ConstraintSetConfig::InitAsDefaultInstance() {
  ...
  signal_recognization_ = const_cast< ::SignalRecognization*>(&::SignalRecognization::default_instance());
}
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 255) {
    ZR_(init_camera_id_, using_hsv_);
    if (has_threshold()) {
  ...
  if (_has_bits_[8 / 32] & 7936) {
    ZR_(gimbal_offset_z_, pitch_offset_);
  }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_using_hsv;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(50)) goto parse_armor_size;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(56)) goto parse_enemy_color;
        break;
      }
      ...
      case 7: {
        ...
        if (input->ExpectTag(66)) goto parse_signal_recognization;
        break;
      }
      ...
      case 8: {
        ...
        if (input->ExpectTag(77)) goto parse_gimbal_offset_z;
        break;
      }
      ...
      case 9: {
        if (tag == 77) {
         parse_gimbal_offset_z:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
                 input, &gimbal_offset_z_)));
          set_has_gimbal_offset_z();
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(85)) goto parse_camera_and_armor_diff;
        break;
      }
      ...
      case 10: {
        if (tag == 85) {
         parse_camera_and_armor_diff:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
                 input, &camera_and_armor_diff_)));
          set_has_camera_and_armor_diff();
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(93)) goto parse_optical_axis_offset;
        break;
      }
      ...
      case 11: {
        if (tag == 93) {
         parse_optical_axis_offset:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
                 input, &optical_axis_offset_)));
          set_has_optical_axis_offset();
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(101)) goto parse_yaw_offset;
        break;
      }
      ...
      case 12: {
        ...
        if (input->ExpectTag(109)) goto parse_pitch_offset;
        break;
      }
...
void ConstraintSetConfig::SerializeWithCachedSizes(
  ...
  // required bool using_hsv = 4;
  if (has_using_hsv()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(4, this->using_hsv(), output);
  }

  // required .Threshold threshold = 5;
  if (has_threshold()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      5, this->threshold(), output);
  }

  // required .ArmorSize armor_size = 6;
  if (has_armor_size()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      6, this->armor_size(), output);
  }

  // required .EnemyColor enemy_color = 7;
  if (has_enemy_color()) {
    ::google::protobuf::internal::WireFormatLite::WriteEnum(
      7, this->enemy_color(), output);
  }

  // required .SignalRecognization signal_recognization = 8;
  if (has_signal_recognization()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      8, this->signal_recognization(), output);
  }

  // required float gimbal_offset_z = 9;
  if (has_gimbal_offset_z()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(9, this->gimbal_offset_z(), output);
  }

  // required float camera_and_armor_diff = 10;
  if (has_camera_and_armor_diff()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(10, this->camera_and_armor_diff(), output);
  }

  // required float optical_axis_offset = 11;
  if (has_optical_axis_offset()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(11, this->optical_axis_offset(), output);
  }

  // required float yaw_offset = 12;
  if (has_yaw_offset()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(12, this->yaw_offset(), output);
  }

  // required float pitch_offset = 13;
  if (has_pitch_offset()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(13, this->pitch_offset(), output);
  }
...
::google::protobuf::uint8* ConstraintSetConfig::SerializeWithCachedSizesToArray(
  ...
  // required bool using_hsv = 4;
  if (has_using_hsv()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(4, this->using_hsv(), target);
  }
  ...
  if (has_armor_size()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        6, this->armor_size(), target);
  }

  // required .EnemyColor enemy_color = 7;
  if (has_enemy_color()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteEnumToArray(
      7, this->enemy_color(), target);
  }
  ...
  if (has_signal_recognization()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        8, this->signal_recognization(), target);
  }

  // required float gimbal_offset_z = 9;
  if (has_gimbal_offset_z()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(9, this->gimbal_offset_z(), target);
  }

  // required float camera_and_armor_diff = 10;
  if (has_camera_and_armor_diff()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(10, this->camera_and_armor_diff(), target);
  }

  // required float optical_axis_offset = 11;
  if (has_optical_axis_offset()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(11, this->optical_axis_offset(), target);
  }

  // required float yaw_offset = 12;
  if (has_yaw_offset()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(12, this->yaw_offset(), target);
  }

  // required float pitch_offset = 13;
  if (has_pitch_offset()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(13, this->pitch_offset(), target);
  }
...
void ConstraintSetConfig::MergeFrom(const ConstraintSetConfig& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_signal_recognization()) {
      mutable_signal_recognization()->::SignalRecognization::MergeFrom(from.signal_recognization());
    }
  }
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    if (from.has_gimbal_offset_z()) {
      set_gimbal_offset_z(from.gimbal_offset_z());
    }
    if (from.has_camera_and_armor_diff()) {
      set_camera_and_armor_diff(from.camera_and_armor_diff());
    }
    if (from.has_optical_axis_offset()) {
      set_optical_axis_offset(from.optical_axis_offset());
    }
    if (from.has_yaw_offset()) {
      set_yaw_offset(from.yaw_offset());
    }
    if (from.has_pitch_offset()) {
      set_pitch_offset(from.pitch_offset());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
void ConstraintSetConfig::Swap(ConstraintSetConfig* other) {
  if (other != this) {
    ...
    std::swap(gimbal_offset_z_, other->gimbal_offset_z_);
    std::swap(camera_and_armor_diff_, other->camera_and_armor_diff_);
    std::swap(optical_axis_offset_, other->optical_axis_offset_);
    std::swap(yaw_offset_, other->yaw_offset_);
    std::swap(pitch_offset_, other->pitch_offset_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
