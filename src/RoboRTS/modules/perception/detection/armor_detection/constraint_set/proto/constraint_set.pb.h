...
class SignalRecognization : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:SignalRecognization)
 private:
...
class ConstraintSetConfig : public ::google::protobuf::Message {
 public:
  ...
  static const int kUsingHsvFieldNumber = 4;
  ...
  static const int kArmorSizeFieldNumber = 6;
  ...
  static const int kEnemyColorFieldNumber = 7;
  ...
  static const int kSignalRecognizationFieldNumber = 8;
  inline const ::SignalRecognization& signal_recognization() const;
  inline ::SignalRecognization* mutable_signal_recognization();
  inline ::SignalRecognization* release_signal_recognization();
  inline void set_allocated_signal_recognization(::SignalRecognization* signal_recognization);

  // required float gimbal_offset_z = 9;
  inline bool has_gimbal_offset_z() const;
  inline void clear_gimbal_offset_z();
  static const int kGimbalOffsetZFieldNumber = 9;
  inline float gimbal_offset_z() const;
  inline void set_gimbal_offset_z(float value);

  // required float camera_and_armor_diff = 10;
  inline bool has_camera_and_armor_diff() const;
  inline void clear_camera_and_armor_diff();
  static const int kCameraAndArmorDiffFieldNumber = 10;
  inline float camera_and_armor_diff() const;
  inline void set_camera_and_armor_diff(float value);

  // required float optical_axis_offset = 11;
  inline bool has_optical_axis_offset() const;
  inline void clear_optical_axis_offset();
  static const int kOpticalAxisOffsetFieldNumber = 11;
  inline float optical_axis_offset() const;
  inline void set_optical_axis_offset(float value);

  // required float yaw_offset = 12;
  inline bool has_yaw_offset() const;
  inline void clear_yaw_offset();
  static const int kYawOffsetFieldNumber = 12;
  inline float yaw_offset() const;
  inline void set_yaw_offset(float value);

  // required float pitch_offset = 13;
  inline bool has_pitch_offset() const;
  inline void clear_pitch_offset();
  static const int kPitchOffsetFieldNumber = 13;
  inline float pitch_offset() const;
  inline void set_pitch_offset(float value);
 ...
 private:
  ...
  inline void set_has_camera_and_armor_diff();
  inline void clear_has_camera_and_armor_diff();
  inline void set_has_optical_axis_offset();
  inline void clear_has_optical_axis_offset();
  inline void set_has_yaw_offset();
  inline void clear_has_yaw_offset();
  inline void set_has_pitch_offset();
  inline void clear_has_pitch_offset();
  ...
  ::SignalRecognization* signal_recognization_;
  int enemy_color_;
...
inline float Threshold::color_thread() const {
  // @@protoc_insertion_point(field_get:Threshold.color_thread)
  return color_thread_;
}
inline void Threshold::set_color_thread(float value) {
  set_has_color_thread();
  color_thread_ = value;
  // @@protoc_insertion_point(field_set:Threshold.color_thread)
}
...
inline float Threshold::blue_thread() const {
  // @@protoc_insertion_point(field_get:Threshold.blue_thread)
  return blue_thread_;
}
inline void Threshold::set_blue_thread(float value) {
  set_has_blue_thread();
  blue_thread_ = value;
  // @@protoc_insertion_point(field_set:Threshold.blue_thread)
}
...
inline float Threshold::red_thread() const {
  // @@protoc_insertion_point(field_get:Threshold.red_thread)
  return red_thread_;
}
inline void Threshold::set_red_thread(float value) {
  set_has_red_thread();
  red_thread_ = value;
  // @@protoc_insertion_point(field_set:Threshold.red_thread)
}
...
inline ::google::protobuf::uint32 SignalRecognization::max_wait_fps() const {
  // @@protoc_insertion_point(field_get:SignalRecognization.max_wait_fps)
  return max_wait_fps_;
}
inline void SignalRecognization::set_max_wait_fps(::google::protobuf::uint32 value) {
  set_has_max_wait_fps();
  max_wait_fps_ = value;
  // @@protoc_insertion_point(field_set:SignalRecognization.max_wait_fps)
}
...
inline float SignalRecognization::min_pulse_angle() const {
  // @@protoc_insertion_point(field_get:SignalRecognization.min_pulse_angle)
...
inline void SignalRecognization::set_min_pulse_angle(float value) {
  ...
  // @@protoc_insertion_point(field_set:SignalRecognization.min_pulse_angle)
}
...
inline ::google::protobuf::uint32 SignalRecognization::min_num() const {
  // @@protoc_insertion_point(field_get:SignalRecognization.min_num)
  return min_num_;
}
inline void SignalRecognization::set_min_num(::google::protobuf::uint32 value) {
  set_has_min_num();
  min_num_ = value;
  // @@protoc_insertion_point(field_set:SignalRecognization.min_num)
}
...
inline bool ConstraintSetConfig::using_hsv() const {
  // @@protoc_insertion_point(field_get:ConstraintSetConfig.using_hsv)
  return using_hsv_;
}
inline void ConstraintSetConfig::set_using_hsv(bool value) {
  set_has_using_hsv();
  using_hsv_ = value;
  // @@protoc_insertion_point(field_set:ConstraintSetConfig.using_hsv)
}
...
inline void ConstraintSetConfig::clear_signal_recognization() {
  if (signal_recognization_ != NULL) signal_recognization_->::SignalRecognization::Clear();
  clear_has_signal_recognization();
}
inline const ::SignalRecognization& ConstraintSetConfig::signal_recognization() const {
  // @@protoc_insertion_point(field_get:ConstraintSetConfig.signal_recognization)
  return signal_recognization_ != NULL ? *signal_recognization_ : *default_instance_->signal_recognization_;
}
inline ::SignalRecognization* ConstraintSetConfig::mutable_signal_recognization() {
  set_has_signal_recognization();
  if (signal_recognization_ == NULL) signal_recognization_ = new ::SignalRecognization;
  // @@protoc_insertion_point(field_mutable:ConstraintSetConfig.signal_recognization)
  return signal_recognization_;
}
inline ::SignalRecognization* ConstraintSetConfig::release_signal_recognization() {
  clear_has_signal_recognization();
  ::SignalRecognization* temp = signal_recognization_;
  signal_recognization_ = NULL;
  return temp;
}
inline void ConstraintSetConfig::set_allocated_signal_recognization(::SignalRecognization* signal_recognization) {
  ...
  // @@protoc_insertion_point(field_set_allocated:ConstraintSetConfig.signal_recognization)
}
...
inline float ConstraintSetConfig::gimbal_offset_z() const {
  // @@protoc_insertion_point(field_get:ConstraintSetConfig.gimbal_offset_z)
  return gimbal_offset_z_;
}
inline void ConstraintSetConfig::set_gimbal_offset_z(float value) {
...
// required float camera_and_armor_diff = 10;
inline bool ConstraintSetConfig::has_camera_and_armor_diff() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void ConstraintSetConfig::set_has_camera_and_armor_diff() {
  _has_bits_[0] |= 0x00000200u;
}
inline void ConstraintSetConfig::clear_has_camera_and_armor_diff() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void ConstraintSetConfig::clear_camera_and_armor_diff() {
  camera_and_armor_diff_ = 0;
  clear_has_camera_and_armor_diff();
}
inline float ConstraintSetConfig::camera_and_armor_diff() const {
  // @@protoc_insertion_point(field_get:ConstraintSetConfig.camera_and_armor_diff)
  return camera_and_armor_diff_;
}
inline void ConstraintSetConfig::set_camera_and_armor_diff(float value) {
  set_has_camera_and_armor_diff();
  camera_and_armor_diff_ = value;
  // @@protoc_insertion_point(field_set:ConstraintSetConfig.camera_and_armor_diff)
}

// required float optical_axis_offset = 11;
inline bool ConstraintSetConfig::has_optical_axis_offset() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void ConstraintSetConfig::set_has_optical_axis_offset() {
  _has_bits_[0] |= 0x00000400u;
}
inline void ConstraintSetConfig::clear_has_optical_axis_offset() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void ConstraintSetConfig::clear_optical_axis_offset() {
  optical_axis_offset_ = 0;
  clear_has_optical_axis_offset();
}
inline float ConstraintSetConfig::optical_axis_offset() const {
  // @@protoc_insertion_point(field_get:ConstraintSetConfig.optical_axis_offset)
  return optical_axis_offset_;
}
inline void ConstraintSetConfig::set_optical_axis_offset(float value) {
  set_has_optical_axis_offset();
  optical_axis_offset_ = value;
  // @@protoc_insertion_point(field_set:ConstraintSetConfig.optical_axis_offset)
}

// required float yaw_offset = 12;
inline bool ConstraintSetConfig::has_yaw_offset() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void ConstraintSetConfig::set_has_yaw_offset() {
  _has_bits_[0] |= 0x00000800u;
}
inline void ConstraintSetConfig::clear_has_yaw_offset() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void ConstraintSetConfig::clear_yaw_offset() {
  yaw_offset_ = 0;
  clear_has_yaw_offset();
}
inline float ConstraintSetConfig::yaw_offset() const {
  // @@protoc_insertion_point(field_get:ConstraintSetConfig.yaw_offset)
  return yaw_offset_;
}
inline void ConstraintSetConfig::set_yaw_offset(float value) {
  set_has_yaw_offset();
  yaw_offset_ = value;
  // @@protoc_insertion_point(field_set:ConstraintSetConfig.yaw_offset)
}

// required float pitch_offset = 13;
inline bool ConstraintSetConfig::has_pitch_offset() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void ConstraintSetConfig::set_has_pitch_offset() {
  _has_bits_[0] |= 0x00001000u;
}
inline void ConstraintSetConfig::clear_has_pitch_offset() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void ConstraintSetConfig::clear_pitch_offset() {
  pitch_offset_ = 0;
  clear_has_pitch_offset();
}
inline float ConstraintSetConfig::pitch_offset() const {
  // @@protoc_insertion_point(field_get:ConstraintSetConfig.pitch_offset)
  return pitch_offset_;
}
inline void ConstraintSetConfig::set_pitch_offset(float value) {
  set_has_pitch_offset();
  pitch_offset_ = value;
  // @@protoc_insertion_point(field_set:ConstraintSetConfig.pitch_offset)
}
