...
class ArmorDetectionAlgorithms : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_max_rotating_fps() const;
  inline void clear_max_rotating_fps();
  static const int kMaxRotatingFpsFieldNumber = 3;
  inline ::google::protobuf::uint32 max_rotating_fps() const;
  inline void set_max_rotating_fps(::google::protobuf::uint32 value);

  // optional uint32 min_rotating_detected_count = 4;
  inline bool has_min_rotating_detected_count() const;
  inline void clear_min_rotating_detected_count();
  static const int kMinRotatingDetectedCountFieldNumber = 4;
  inline ::google::protobuf::uint32 min_rotating_detected_count() const;
  inline void set_min_rotating_detected_count(::google::protobuf::uint32 value);
  ...
  static const int kUndetectedArmorDelayFieldNumber = 5;
 ...
 private:
  ...
  inline void set_has_max_rotating_fps();
  inline void clear_has_max_rotating_fps();
  inline void set_has_min_rotating_detected_count();
  inline void clear_has_min_rotating_detected_count();
  ...
  ::google::protobuf::uint32 max_rotating_fps_;
  ::google::protobuf::uint32 min_rotating_detected_count_;
...
// optional uint32 max_rotating_fps = 3;
inline bool ArmorDetectionAlgorithms::has_max_rotating_fps() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void ArmorDetectionAlgorithms::set_has_max_rotating_fps() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ArmorDetectionAlgorithms::clear_has_max_rotating_fps() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ArmorDetectionAlgorithms::clear_max_rotating_fps() {
  max_rotating_fps_ = 0u;
  clear_has_max_rotating_fps();
}
inline ::google::protobuf::uint32 ArmorDetectionAlgorithms::max_rotating_fps() const {
  // @@protoc_insertion_point(field_get:ArmorDetectionAlgorithms.max_rotating_fps)
  return max_rotating_fps_;
}
inline void ArmorDetectionAlgorithms::set_max_rotating_fps(::google::protobuf::uint32 value) {
  set_has_max_rotating_fps();
  max_rotating_fps_ = value;
  // @@protoc_insertion_point(field_set:ArmorDetectionAlgorithms.max_rotating_fps)
}

// optional uint32 min_rotating_detected_count = 4;
inline bool ArmorDetectionAlgorithms::has_min_rotating_detected_count() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void ArmorDetectionAlgorithms::set_has_min_rotating_detected_count() {
  _has_bits_[0] |= 0x00000008u;
}
inline void ArmorDetectionAlgorithms::clear_has_min_rotating_detected_count() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void ArmorDetectionAlgorithms::clear_min_rotating_detected_count() {
  min_rotating_detected_count_ = 0u;
  clear_has_min_rotating_detected_count();
}
inline ::google::protobuf::uint32 ArmorDetectionAlgorithms::min_rotating_detected_count() const {
  // @@protoc_insertion_point(field_get:ArmorDetectionAlgorithms.min_rotating_detected_count)
  return min_rotating_detected_count_;
}
inline void ArmorDetectionAlgorithms::set_min_rotating_detected_count(::google::protobuf::uint32 value) {
  set_has_min_rotating_detected_count();
  min_rotating_detected_count_ = value;
  // @@protoc_insertion_point(field_set:ArmorDetectionAlgorithms.min_rotating_detected_count)
}
...
inline ::google::protobuf::uint32 ArmorDetectionAlgorithms::undetected_armor_delay() const {
  // @@protoc_insertion_point(field_get:ArmorDetectionAlgorithms.undetected_armor_delay)
...
inline void ArmorDetectionAlgorithms::set_undetected_armor_delay(::google::protobuf::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:ArmorDetectionAlgorithms.undetected_armor_delay)
}
