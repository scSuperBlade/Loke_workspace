...
void protobuf_AssignDesc_serial_5fcom_5fconfig_2eproto() {
  ...
  static const int SerialPortConfig_offsets_[12] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SerialPortConfig, link_row_),
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SerialPortConfig, uwb_frame_id_),
  };
...
void protobuf_ShutdownFile_serial_5fcom_5fconfig_2eproto() {
  ...
  delete SerialPortConfig::_default_uwb_frame_id_;
}
...
void protobuf_AddDesc_serial_5fcom_5fconfig_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\n\010is_debug\030\007 \001(\010:\004true\022\033\n\014is_simulator\030\010"
    " \001(\010:\005false\022\024\n\010link_row\030\t \001(\001:\00240\022\030\n\013lin"
    "k_column\030\n \001(\001:\003130\022\026\n\tlink_beam\030\013 \001(\001:\003"
    "100\022\031\n\014uwb_frame_id\030\014 \001(\t:\003uwb", 350);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "serial_com_config.proto", &protobuf_RegisterTypes);
  SerialPortConfig::_default_parity_ =
      new ::std::string("N", 1);
  SerialPortConfig::_default_uwb_frame_id_ =
...
::std::string* SerialPortConfig::_default_uwb_frame_id_ = NULL;
#ifndef _MSC_VER
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 8: {
        ...
        if (input->ExpectTag(73)) goto parse_link_row;
        break;
      }
      ...
      case 9: {
        ...
        if (input->ExpectTag(81)) goto parse_link_column;
        break;
      }
      ...
      case 10: {
        ...
        if (input->ExpectTag(89)) goto parse_link_beam;
        break;
      }
      ...
      case 11: {
        ...
        if (input->ExpectTag(98)) goto parse_uwb_frame_id;
        break;
      }
...
void SerialPortConfig::SerializeWithCachedSizes(
  ...
  // optional double link_row = 9 [default = 40];
  if (has_link_row()) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(9, this->link_row(), output);
  }

  // optional double link_column = 10 [default = 130];
  if (has_link_column()) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(10, this->link_column(), output);
  }

  // optional double link_beam = 11 [default = 100];
  if (has_link_beam()) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(11, this->link_beam(), output);
  }
...
::google::protobuf::uint8* SerialPortConfig::SerializeWithCachedSizesToArray(
  ...
  // optional double link_row = 9 [default = 40];
  if (has_link_row()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(9, this->link_row(), target);
  }

  // optional double link_column = 10 [default = 130];
  if (has_link_column()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(10, this->link_column(), target);
  }

  // optional double link_beam = 11 [default = 100];
  if (has_link_beam()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(11, this->link_beam(), target);
  }
...
void SerialPortConfig::MergeFrom(const SerialPortConfig& from) {
  ...
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    if (from.has_link_row()) {
      set_link_row(from.link_row());
    }
...
void SerialPortConfig::Swap(SerialPortConfig* other) {
  if (other != this) {
    ...
    std::swap(link_row_, other->link_row_);
