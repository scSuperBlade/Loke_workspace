...
inline float AStarPlannerConfig::goal_search_tolerance() const {
  // @@protoc_insertion_point(field_get:rrts.planning.global_planner.AStarPlannerConfig.goal_search_tolerance)
...
inline void AStarPlannerConfig::set_goal_search_tolerance(float value) {
  ...
  // @@protoc_insertion_point(field_set:rrts.planning.global_planner.AStarPlannerConfig.goal_search_tolerance)
}
