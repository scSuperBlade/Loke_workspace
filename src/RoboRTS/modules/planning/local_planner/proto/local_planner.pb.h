...
inline double LocalAlgorithms::frequency() const {
  // @@protoc_insertion_point(field_get:rrts.planning.local_planner.LocalAlgorithms.frequency)
  return frequency_;
}
inline void LocalAlgorithms::set_frequency(double value) {
  set_has_frequency();
  frequency_ = value;
  // @@protoc_insertion_point(field_set:rrts.planning.local_planner.LocalAlgorithms.frequency)
}
