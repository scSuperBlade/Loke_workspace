...
int SegmentImage(Mat &_src3f, Mat &pImgInd, double sigma = 0.5, double k = 200, int min_size = 50);

int SegmentImg(unsigned char * src, int *&regIdx, int nRow,int nCol,float pixelsize,double sigma = 0.5, double k = 200, int min_size = 50);
