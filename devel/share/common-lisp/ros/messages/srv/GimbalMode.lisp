...
(cl:defmethod cl:initialize-instance :after ((m <GimbalMode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GimbalMode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name messages-srv:<GimbalMode-request> is deprecated: use messages-srv:GimbalMode-request instead.")))

(cl:ensure-generic-function 'gimbal_mode-val :lambda-list '(m))
(cl:defmethod gimbal_mode-val ((m <GimbalMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader messages-srv:gimbal_mode-val is deprecated.  Use messages-srv:gimbal_mode instead.")
  (gimbal_mode m))
...
(cl:defmethod cl:initialize-instance :after ((m <GimbalMode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GimbalMode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name messages-srv:<GimbalMode-response> is deprecated: use messages-srv:GimbalMode-response instead.")))
