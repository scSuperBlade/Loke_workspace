...
(cl:defmethod cl:initialize-instance :after ((m <LocalizationGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LocalizationGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name messages-msg:<LocalizationGoal> is deprecated: use messages-msg:LocalizationGoal instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LocalizationGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#Send a flag to server to control the thread start, pause, restart and stop~%#command == 1 start~%#command == 2 stop~%int32 command~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LocalizationGoal)))
  "Returns full string definition for message of type 'LocalizationGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#Send a flag to server to control the thread start, pause, restart and stop~%#command == 1 start~%#command == 2 stop~%int32 command~%~%~%"))
