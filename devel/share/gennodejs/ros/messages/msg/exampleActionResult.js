...
class exampleActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = exampleResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.result = exampleResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.result !== undefined) {
      resolved.result = exampleResult.Resolve(msg.result)
    }
    else {
      resolved.result = new exampleResult()
    }
