...
class caissonDetectionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('isCheck')) {
        this.isCheck = initObj.isCheck
      }
      else {
        this.isCheck = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [isCheck]
    bufferOffset = _serializer.bool(obj.isCheck, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new caissonDetectionFeedback(null);
    ...
    // Deserialize message field [isCheck]
    data.isCheck = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new caissonDetectionFeedback(null);
    ...
    if (msg.isCheck !== undefined) {
      resolved.isCheck = msg.isCheck;
    }
    else {
      resolved.isCheck = false
    }
...
module.exports = caissonDetectionFeedback;
