...
"""autogenerated by genpy from messages/LocalPlannerActionResult.msg. Do not edit."""
import sys
...
class LocalPlannerActionResult(genpy.Message):
  ...
  _type = "messages/LocalPlannerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','messages/LocalPlannerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = messages.msg.LocalPlannerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = messages.msg.LocalPlannerResult()
