...
"""autogenerated by genpy from messages/GlobalPlannerActionResult.msg. Do not edit."""
import sys
...
class GlobalPlannerActionResult(genpy.Message):
  ...
  _type = "messages/GlobalPlannerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','messages/GlobalPlannerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = messages.msg.GlobalPlannerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = messages.msg.GlobalPlannerResult()
