...
"""autogenerated by genpy from messages/exampleActionResult.msg. Do not edit."""
import sys
...
class exampleActionResult(genpy.Message):
  _md5sum = "363a8255aae19ae465319475e1a86dad"
  _type = "messages/exampleActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','messages/exampleResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(exampleActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = messages.msg.exampleResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = messages.msg.exampleResult()
